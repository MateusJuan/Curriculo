...
export function ExperienceSection() {
  ...
  const projects = [
    {
      title: t.expeciencias.N4vix.titulo,
      description: t.expeciencias.N4vix.descricao,
      technologies: [
      ...
      links: {
        live: "https://n4vix.vercel.app/",
        playStore: "https://play.google.com/store/apps/details?id=com.deliveryrace.app",
      },
      status: t.expeciencias.N4vix.status,
      contributors: [],
      highlights: [
        t.expeciencias.N4vix.highlights[0],
        t.expeciencias.N4vix.highlights[1],
        t.expeciencias.N4vix.highlights[2],
      ],
    },
    {
      title: t.expeciencias.Escalas.titulo,
      description: t.expeciencias.Escalas.descricao,
      technologies: [
        { name: "React Native", icon: Smartphone },
        { name: "Node.js", icon: Globe },
    ...
    },
    {
      ...
      description: t.expeciencias["Portifólio Pessoal"].descricao,
      technologies: [
    ...
    },
    {
      ...
      description: t.expeciencias["App de vendas de E-commerce"].descricao,
      technologies: [
        { name: "React Native", icon: Smartphone },
        { name: "Node.js", icon: Globe },
        { name: "Supabase", icon: Server },
    ...
    },
    {
      ...
      description: t.expeciencias["Quiz online de Biologia"].descricao,
      technologies: [
